...
Namespace My
    ...
    Module MyWpfExtension
        ...
        Private s_Debug As New ThreadSafeObjectProvider(Of Global.Microsoft.VisualBasic.Logging.Log)
        ''' <summary>
        ...
        End Property
        ''' <summary>
        ''' Returns the application Debug. The listeners can be configured by the application's configuration file.
        ''' </summary>
        <Global.System.Diagnostics.CodeAnalysis.SuppressMessageAttribute("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")> _
        Friend ReadOnly Property Debug() As Global.Microsoft.VisualBasic.Logging.Log
            Get
                Return s_Debug.GetInstance()
            End Get
        End Property
